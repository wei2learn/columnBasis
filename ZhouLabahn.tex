...
\noindent \vspace{1mm}
 \textbf{Keywords:} Kernel basis, Nullspace basis, Column Basis, Complexity
...
by rows. We partition $\mathbf{N}$ into $\left[\mathbf{N}_{1},\mathbf{N}_{2}\right]$
...
\]
a contradiction since we know from \prettyref{lem:kernelBasisInOrderBasis}
...
the same dimension as the row dimension of $\mathbf{N}_{i}$ and 
\[
