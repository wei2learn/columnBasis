...
\noindent \vspace{1mm}
 \textbf{Keywords:} Nullspace basis, Complexity
...
for example \cite{bcl:2006,beelen:1988,Giorgi2003,GSSV2012,sarkar2011,SS2011}.
...
is however pointed out in \cite{sarkar2011,SS2011} that randomization
...
column rank matrices. Our method depends on kernel computation of
$\mathbf{F}$ along with finding a factorization of the input matrix
...
the number of rows. The paper ends with a conclusion along with topics
for future research.
...
respectively. Let $\vec{\sigma}_{i}=\left[\xi/2^{i-1}+1,\dots,\xi/2^{i-1}+1\right]$
...
row degrees bounded by $\vec{s}$, or equivalently, having $-\vec{s}$-column
degrees bounded by 0. 
\end{itemize}
...
entries of $\vec{t}$; 
\item (ii) if $\vec{t}$ has $r$ entries and $\vec{s}^{~\prime}$ is the
list of the $r$ largest entries of $\vec{s}$, then $\vec{t}\le\vec{s}^{~\prime}$. 
\end{itemize}
\end{lem}
\begin{proof}
...
% 
In a later publication we will show how to use our column basis algorithm
for efficient deterministic computations of matrix determinant, Hermite
form, and computations of column reduced form and Popov form for matrices
of any rank and any dimension
\begin{thebibliography}{10}

\bibitem{bcl:2006}
B.~Beckermann, H.~Cheng, and G.~Labahn.
\newblock Fraction-free row reduction of matrices of {O}re polynomials.
\newblock {\em Journal of Symbolic Computation}, 41(1):513--543, 2006.

\bibitem{BeLa94}
B.~Beckermann and G.~Labahn.
\newblock A uniform approach for the fast computation of matrix-type {Pad{\'e}}
  approximants.
...
\newblock {\em Journal of Computational and Applied Math}, 5-34, 1997.
...
\newblock Shifted normal forms of polynomial matrices.
\newblock In {\em Proceedings of the International Symposium on Symbolic and
  Algebraic Computation}, ISSAC'99, pages 189--196, 1999.

\bibitem{BLV:jsc06}
B.~Beckermann, G.~Labahn, and G.~Villard.
\newblock Normal forms for general polynomial matrices.
\newblock {\em Journal of Symbolic Computation}, 41(6):708--737, 2006.

\bibitem{beelen:1988}
Th. G.~J. Beelen and P.M.~Van Dooren.
\newblock An improved algorithm for the computation of {K}ronecker's canonical
  form of a singular pencil.
\newblock {\em Linear Algebra and its Applications}, 105:9--65, 1988.

\bibitem{BVP:1988}
Th. G.~J. Beelen, G.~J. van~den Hurk, and C.~Praagman.
\newblock A new method for computing a column reduced polynomial matrix.
\newblock {\em Syst. Control Lett.}, 10(4):217--224, 1988.

\bibitem{Giorgi2003}
P.~Giorgi, C.-P. Jeannerod, and G.~Villard.
\newblock On the complexity of polynomial matrix computations.
\newblock In {\em {Proceedings of the International Symposium on Symbolic and
  Algebraic Computation, Philadelphia, Pennsylvania, USA}}, pages 135--142. ACM
  Press, 2003.
...
\newblock {\em Journal of Symbolic Computation: Special issue in honour of the
  research and influence of Joachim von zur Gathen at 60}, 47(4):422--453,
  2012.
...
\bibitem{li:2006}
Chao Li.
\newblock Lattice compression of polynomial matrices.
\newblock Master's thesis, School of Computer Science, University of Waterloo,
  2006.

\bibitem{sarkar2011}
S.~Sarkar.
\newblock Computing {P}opov forms of polynomial matrices.
...
\newblock In {\em Proceedings of the International Symposium on Symbolic and
  Algebraic Computation}, pages 297--304, 2011.

\bibitem{storjohann-villard:2005}
A.~Storjohann and G.~Villard.
\newblock Computing the rank and a small nullspace basis of a polynomial
  matrix.
\newblock In {\em Proceedings of the International Symposium on Symbolic and
  Algebraic Computation}, ISSAC'05, pages 309--316, 2005.
...
\bibitem{vonzurgathen}
J.~von~zur Gathen and J~Gerhard.
\newblock {\em Modern Computer Algebra}.
\newblock Cambridge University Press, 2nd edition edition, 2003.

\bibitem{zhou:phd2012}
W.~Zhou.
...
\newblock {\em Journal of Symbolic Computation}, 47:793--819, 2012.

\bibitem{za2009}
Wei Zhou and George Labahn.
\newblock Efficient computation of order bases.
\newblock In {\em Proceedings of the International Symposium on Symbolic and
  Algebraic Computation}, ISSAC'09, pages 375--382. ACM, 2009.

\bibitem{za2012}
Wei Zhou, George Labahn, and Arne Storjohann.
\newblock Computing minimal nullspace bases.
\newblock In {\em Proceedings of the International Symposium on Symbolic and
  Algebraic Computation}, ISSAC'12, pages 375--382. ACM, 2012.
